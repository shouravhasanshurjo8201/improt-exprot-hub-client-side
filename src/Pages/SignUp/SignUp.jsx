        ...
        <div className='flex flex-col justify-center items-center flex-1 min-h-screen bg-emerald-100'>
            <div data-aos="fade-up" className='container mx-auto '>
                <div className='flex flex-col justify-center items-center p-5' >
                    <fieldset className="fieldset bg-emerald-300 border-base-200 rounded-box w-xs border p-4 text-white">
                        {user ? '' : <h1 className='text-center font-bold text-black text-xl'>Sign Up</h1>}
                        <form onSubmit={handleSignup}>
                            ...
                            <button className="btn btn-neutral mt-4 bg-cyan-400 font-bold w-full text-black border-none shadow-none">Sign Up</button>
                        </form>
                        <button onClick={handleGoogleLogin} className="btn bg-white font-bold w-full text-black border-[#e5e5e5] my-4 shadow-none">
                        ...
                        <div>
                            ...
                            <p className='text-black text-[15px] mt-2'>Already Have An Account?  Go to <Link to='/login' className='font-bold text-blue-600'>Login</Link></p>
                        </div>
                    </fieldset>
                </div>
            </div>
