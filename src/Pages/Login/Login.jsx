      ...
      <div data-aos="fade-up" className='container mx-auto '>
        <div className='flex flex-col justify-center items-center p-5' >
          <div className=" bg-background1 border-base-200 rounded-box w-xs border p-4 text-white">
            {user ? '' : <h1 className='text-center font-bold text-emerald-800 text-2xl'>Login</h1>}
            {user ? <div className='flex flex-col justify-center items-center'>
              ...
              <form onSubmit={handleLogin}>
                <div className='fieldset'>
                  ...
                  <button className="btn btn-neutral mt-4 bg-emerald-400 hover:bg-emerald-500 font-bold text-black border-none shadow-none hover:text-lg">Login</button>
                </div>
              </form>
              <div>
                <button onClick={handleGoogleLogin} className="btn bg-white font-bold w-full text-black border-[#e5e5e5] my-4 border-none shadow-none hover:text-lg">
                ...
                <p className='text-black mt-2'>Don't have an Account?  Go to  <Link to='/signup' className='font-bold text-blue-500'>Sign Up</Link></p>
              </div>
            </div>}
          </div>
        </div>
