...
const UpdateProfile = () => {
    ...
    return (
        <div className="bg-emerald-100 flex flex-col items-center justify-center flex-1 ">
            <div data-aos="fade-up" className='container mx-auto '>
                <form onSubmit={handleUpdateProfile}>
                    <div className=" flex flex-col gap-2 justify-center items-center bg-blue-300 m-10 p-5 rounded-xl w-8/12 lg:w-4/12 mx-auto">
