...
const Footer = () => {
    return (
        <div data-aos="fade-up" className="bg-background3">
            <div className="container mx-auto">
                <div data-aos="fade-up" className="lg:flex justify-around items-center p-10 gap-10 text-white">
                    <div data-aos="fade-up" className="w-full pb-2">
                    ...
                    <div data-aos="fade-up" className="w-full lg:pl-10 flex flex-col pb-2">
                    ...
                    <div data-aos="fade-up" className="w-full  flex flex-col pb-2">
                    ...
                    <div data-aos="fade-up" className="w-full  flex flex-col">
